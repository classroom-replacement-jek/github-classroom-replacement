<template>
    ...
    <classes-assignment-creation @close="showAssignmentCreation = false" v-if="showAssignmentCreation"></classes-assignment-creation>
</template>
